...
fn main() {
    ...
    dict_upper.insert("EXAMPLE", "1");
    dict_upper.insert("TEST", "2");
    
    let mut dict_lower = HashMap::new();
    dict_lower.insert("example", "1");
    dict_lower.insert("test", "2");

    let mut dict_mixed = HashMap::new();
    dict_mixed.insert("Example", "1");
    dict_mixed.insert("Test", "2");

    let mut dict_empty: HashMap<&str, &str> = HashMap::new();
