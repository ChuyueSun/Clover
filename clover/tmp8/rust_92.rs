...
fn main() {
    // You can test the function with some values here
    println!("{}", any_int(4.0, 2.0, 2.0)); // should print true
    println!("{}", any_int(4.0, 2.1, 1.9)); // should print false
    println!("{}", any_int(10.0, 5.0, 3.0)); // should print false
}
