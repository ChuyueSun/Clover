...
fn main() {
    // Example usage
    println!("any_int(1.0, 2.0, 3.0): {}", any_int(1.0, 2.0, 3.0)); // true
    println!("any_int(1.5, 2.0, 3.5): {}", any_int(1.5, 2.0, 3.5)); // false
    println!("any_int(4.0, 2.0, 2.0): {}", any_int(4.0, 2.0, 2.0)); // true
}
