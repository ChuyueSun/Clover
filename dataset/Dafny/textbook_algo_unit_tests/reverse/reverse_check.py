...
def run_and_check_output():
    ...
    result=subprocess.run(f"~/llm4dafny/exp/dafny/Binaries/Dafny run --no-verify --unicode-char=false reverse_tests.dfy", shell=True, capture_output=True)
    ...
    expected_outputs = '987654321;10172361822;42-10-1;;715947352311;'
