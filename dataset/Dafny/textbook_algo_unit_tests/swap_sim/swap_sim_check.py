...
def run_and_check_output():
    ...
    expected_outputs = "(Test 1: SwapSimultaneous(3,5) = , 5, 3, \\n)(Test 2: SwapSimultaneous(-1,0) = , 0, -1, \\n)(Test 3: SwapSimultaneous(0,0) = , 0, 0, \\n)(Test 4: SwapSimultaneous(100,-100) = , -100, 100, \\n)(Test 5: SwapSimultaneous(123456789,987654321) = , 987654321, 123456789, \\n)"
