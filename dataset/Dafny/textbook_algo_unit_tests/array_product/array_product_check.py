...
def run_and_check_output():
    ...
    result=subprocess.run(f"~/llm4dafny/exp/dafny/Binaries/Dafny run --no-verify --unicode-char=false array_product_tests.dfy", shell=True, capture_output=True)
    ...
    expected_outputs = '41018;000;123;343;4-44'
