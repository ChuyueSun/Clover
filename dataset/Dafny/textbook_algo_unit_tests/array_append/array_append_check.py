...
def run_and_check_output():
    ...
    result=subprocess.run(f"~/llm4dafny/exp/dafny/Binaries/Dafny run --no-verify --unicode-char=false array_append_tests.dfy", shell=True, capture_output=True)
    ...
    expected_outputs = '1234;1;6780;-1-2-3-4;10203040'
