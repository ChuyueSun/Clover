...
def run_and_check_output():
    ...
    result=subprocess.run(f"~/llm4dafny/exp/dafny/Binaries/Dafny run --no-verify --unicode-char=false copy_part_tests.dfy", shell=True, capture_output=True)
    ...
    expected_outputs = '1238;110114;413141;11634;1718191;'
