...
def run_and_check_output():
    ...
    expected_outputs = "(Test 1: BinarySearch(new int[]{1, 2, 3, 4, 5}, 3) = , 2, \\n)(Test 2: BinarySearch(new int[]{10, 20, 30, 40, 50}, 20) = , 1, \\n)(Test 3: BinarySearch(new int[]{2, 4, 6, 8, 10}, 1) = , 0, \\n)(Test 4: BinarySearch(new int[]{5, 5, 5, 5, 5}, 5) = , 0, \\n)(Test 5: BinarySearch(new int[]{0}, 0) = , 0, \\n)"
