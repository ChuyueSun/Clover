...
def run_and_check_output():
    ...
    result=subprocess.run(f"~/llm4dafny/exp/dafny/Binaries/Dafny run --no-verify --unicode-char=false triple2_tests.dfy", shell=True, capture_output=True)
    ...
    expected_outputs = '(Test 1: Triple(1) = , 3, \\n)(Test 2: Triple(2) = , 6, \\n)(Test 3: Triple(-2) = , -6, \\n)(Test 4: Triple(0) = , 0, \\n)(Test 5: Triple(100) = , 300, \\n)'
