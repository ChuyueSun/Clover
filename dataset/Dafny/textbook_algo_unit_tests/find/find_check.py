...
def run_and_check_output():
    ...
    result=subprocess.run(f"~/llm4dafny/exp/dafny/Binaries/Dafny run --no-verify --unicode-char=false find_tests.dfy", shell=True, capture_output=True)
    ...
    expected_outputs = '(Test 1: Find(...) = , 2, \\n)(Test 2: Find(...) = , 4, \\n)(Test 3: Find(...) = , 3, \\n)(Test 4: Find(...) = , -1, \\n)(Test 5: Find(...) = , -1, \\n)'
