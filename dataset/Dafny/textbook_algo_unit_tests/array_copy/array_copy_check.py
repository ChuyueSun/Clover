...
def run_and_check_output():
    ...
    result=subprocess.run(f"~/llm4dafny/exp/dafny/Binaries/Dafny run --no-verify --unicode-char=false array_copy_tests.dfy", shell=True, capture_output=True)
    ...
    expected_outputs = '123;100;helloworld;truefalsetruefalse;abcde'
