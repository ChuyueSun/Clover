...
def run_and_check_output():
    ...
    result=subprocess.run(f"~/llm4dafny/exp/dafny/Binaries/Dafny run --no-verify --unicode-char=false remove_front_tests.dfy", shell=True, capture_output=True)
    ...
    expected_outputs = '1234;;-1-2-3;0000;100200300400;'
