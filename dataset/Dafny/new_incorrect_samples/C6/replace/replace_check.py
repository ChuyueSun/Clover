...
def run_and_check_output():
    ...
    result=subprocess.run(f"~/llm4dafny/exp/dafny/Binaries/Dafny run --no-verify --unicode-char=false replace_tests.dfy", shell=True, capture_output=True)
    ...
    expected_outputs = '123-1-1;-1;-1-2-3-4;-1-1-1-1-1;100200-1-1-1;'
