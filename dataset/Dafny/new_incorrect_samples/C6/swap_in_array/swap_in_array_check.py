...
def run_and_check_output():
    ...
    result=subprocess.run(f"~/llm4dafny/exp/dafny/Binaries/Dafny run --no-verify --unicode-char=false swap_in_array_tests.dfy", shell=True, capture_output=True)
    ...
    expected_outputs = '52341;321;3543;21;1;'
