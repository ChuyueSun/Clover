...
def run_and_check_output():
    ...
    expected_outputs = '(Test 1: LinearSearch3(arr1, P1) = , 0, \\n)(Test 2: LinearSearch3(arr2, P2) = , 0, \\n)(Test 3: LinearSearch3(arr3, P3) = , 0, \\n)(Test 4: LinearSearch3(arr4, P4) = , 0, \\n)(Test 5: LinearSearch3(arr5, P5) = , 0, \\n)'
