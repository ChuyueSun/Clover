...
def run_and_check_output():
    ...
    result=subprocess.run(f"~/llm4dafny/exp/dafny/Binaries/Dafny run --no-verify --unicode-char=false even_list_tests.dfy", shell=True, capture_output=True)
    ...
    expected_outputs = '13579;101;-1-1;;112335475971;'
