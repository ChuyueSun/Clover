...
def run_and_check_output():
    ...
    result=subprocess.run(f"~/llm4dafny/exp/dafny/Binaries/Dafny run --no-verify --unicode-char=false selectionsort_tests.dfy", shell=True, capture_output=True)
    ...
    expected_outputs = '54321;98765;54321;54321;11111;'
