...
def run_and_check_output():
    ...
    result=subprocess.run(f"~/llm4dafny/exp/dafny/Binaries/Dafny run --no-verify --unicode-char=false online_max_tests.dfy", shell=True, capture_output=True)
    ...
    expected_outputs = '(Test 1: onlineMax(...) = , 3, \\n)(Test 2: onlineMax(...) = , 5, \\n)(Test 3: onlineMax(...) = , 5, \\n)(Test 4: onlineMax(...) = , 2, \\n)(Test 5: onlineMax(...) = , 2, \\n)'
