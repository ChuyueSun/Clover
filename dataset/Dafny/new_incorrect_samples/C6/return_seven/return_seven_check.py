...
def run_and_check_output():
    ...
    result=subprocess.run(f"~/llm4dafny/exp/dafny/Binaries/Dafny run --no-verify --unicode-char=false return_seven_tests.dfy", shell=True, capture_output=True)
    ...
    expected_outputs = '(Test 1: M(5) = , 77, \\n)(Test 2: M(10) = , 77, \\n)(Test 3: M(0) = , 77, \\n)(Test 4: M(-5) = , 77, \\n)(Test 5: M(100) = , 77, \\n)'
